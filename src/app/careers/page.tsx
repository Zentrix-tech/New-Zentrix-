    ...
    <div style={{ background: "var(--color-bg)", minHeight: "100vh" }}>
      ...
      >
        ...
        <div className="container-zentrix" style={{ position: "relative", zIndex: 2 }}>
          ...
          >
            <span style={{ color: "#F8FAFC" }}>Build the Future</span>
            <br />
            <span
              style={{
          ...
          >
            {perks.map((perk, i) => (
              ...
              >
                ...
                <p style={{ fontFamily: "Inter, sans-serif", fontSize: "0.875rem", color: "#94A3B8", lineHeight: 1.65 }}>{perk.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            {openRoles.map((role, i) => (
              ...
              >
                ...
                {/* Info */}
                <div style={{ flex: 1 }}>
                  <h4 style={{ fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "#F8FAFC", marginBottom: "4px" }}>
                    {role.title}
                  </h4>
                  <p style={{ fontFamily: "Inter, sans-serif", fontSize: "0.825rem", color: "#94A3B8" }}>{role.desc}</p>
                </div>
                ...
                <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", alignItems: "center" }}>
                  ...
                  <span style={{ padding: "4px 12px", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "100px", fontFamily: "Inter, sans-serif", fontSize: "0.75rem", color: "#94A3B8" }}>
                    {role.level}
                  </span>
                  {role.stack.slice(0, 2).map((s) => (
                    <span key={s} style={{ padding: "4px 10px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.05)", borderRadius: "100px", fontFamily: "Inter, sans-serif", fontSize: "0.7rem", color: "#475569" }}>
                      {s}
                    </span>
                  ))}
                </div>
      ...
      <section style={{ padding: "clamp(60px,8vw,100px) 0", textAlign: "center" }}>
        <div className="container-zentrix">
          ...
          <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: "clamp(1.8rem,4vw,2.8rem)", fontWeight: 800, color: "#F8FAFC", marginBottom: "12px", letterSpacing: "-0.02em" }}>
            Don&apos;t see your role?
          </h2>
          <p style={{ fontFamily: "Inter, sans-serif", fontSize: "1.05rem", color: "#94A3B8", marginBottom: "28px", maxWidth: "500px", margin: "0 auto 28px" }}>
